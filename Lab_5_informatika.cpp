...
{
	// Создаём рандомный массив с числами от 0 до 5, чтобы чаще совпадали первые элементы 
...
int main()
{
	...
	{
		matrix[i] = new int[nCol]; // каждому элементу указателей на сроку присваиваем адрес начала участка памяти
	}
